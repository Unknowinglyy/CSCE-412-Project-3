...
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00063}00063\ \ \ \ \ \textcolor{comment}{//check\ if\ all\ the\ servers\ are\ full}}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00064}00064\ \ \ \ \ \textcolor{keywordtype}{bool}\ full\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00065}00065\ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}\&\ server:\ webServers)\{}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00066}00066\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(server-\/>getQueueSize()\ <\ 50)\{}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00067}00067\ \ \ \ \ \ \ \ \ \ \ \ \ full\ =\ \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00068}00068\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00069}00069\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00070}00070\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\{}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00071}00071\ \ \ \ \ \ \ \ \ \ \ \ \ full\ =\ \textcolor{keyword}{true};}
...
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00074}00074\ \ \ \ \ \textcolor{keywordflow}{if}(full)\{}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00075}00075\ \ \ \ \ \ \ \ \ \textcolor{comment}{//add\ a\ new\ server}}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00076}00076\ \ \ \ \ \ \ \ \ webServers.push\_back(\textcolor{keyword}{new}\ \mbox{\hyperlink{classwebserver}{webserver}}());}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00077}00077\ \ \ \ \ \ \ \ \ std::cout\ <<\ \textcolor{stringliteral}{"{}Server\ added."{}}\ <<\ std::endl;}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00078}00078\ \ \ \ \ \ \ \ \ \textcolor{comment}{//distribute\ requests\ to\ the\ new\ server}}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00079}00079\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classloadbalancer_a7d13e7ef044c1d9b7ae3f422f21a0d00}{distributeRequests}}();}
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00080}00080\ \ \ \ \ \}\ }
\DoxyCodeLine{\Hypertarget{loadbalancer_8cpp_source_l00081}00081\ \}}
